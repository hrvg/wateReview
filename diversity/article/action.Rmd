...
First, we performed a data-driven literature review by assembling a corpus of 30,000 water resources research articles and analyzing them with Latent Dirichlet Allocation (LDA, [@Blei2003]), a generative Bayesian model- describing topics as a probability distribution over words, and documents as a probability distribution over topics.
