---
title: "A kick-ass title"
author: Jennifer Gamez-Rodríguez, Hervé Guillon, Romina Diaz-Gomez and Noelle Patterson
date: May 30, 2019
output:
  html_document:
    toc: true
...
```{r libraries, warning = FALSE, message = FALSE, include = TRUE, echo = TRUE, results = "asis"}
#################
### LIBRARIES ###
#################
library(raster)
...
```{r user_functions, warning = FALSE, message = FALSE, include = TRUE, echo = TRUE}
#################
### FUNCTIONS ###
#################
...
```{r data_loading, warning = FALSE, message = FALSE, include = TRUE, echo = TRUE}
############
### MAIN ###
############
...
```{r mapping_descriptors, warning = FALSE, message = FALSE, include = TRUE, echo = TRUE}
...
print(names(countries_shapefile))

```

## Histograms

We did some histograms.

```{r histograms, warning = FALSE, message = FALSE, include = TRUE, echo = TRUE}
## HISTOGRAMS
...
```{r main, warning = FALSE, message = FALSE, include = TRUE, echo = TRUE}
## RESCALING DATA
...
```{r clustering_v2, warning = FALSE, message = FALSE, include = TRUE, echo = TRUE}
library("clValid")
library("factoextra")
library("cowplot")
