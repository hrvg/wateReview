...
BATCH_SIZE = 32 # change this when encountering oom on gpu
LEARNING_RATE = 2e-5
NUM_TRAIN_EPOCHS = 24
...
train_data_path='../input/location/train.csv'
train = pd.read_csv(train_data_path)
test = pd.read_csv('../input/location/test.csv')

ID = 'fnames'
DATA_COLUMN = 'abstract'
LABEL_COLUMNS = ["Irrelevant", "Argentina", "Bahamas", "Barbados","Belize","Bolivia","Brazil","Caribbean","Chile","Colombia","Costa.Rica","Dominican.Republic","Ecuador","El.Salvador","Guatemala","Haiti","Honduras","Jamaica","Mexico","Nicaragua","Panama","Paraguay","Peru","Trinidad.and.Tobago","Uruguay","Venezuela"]
...
def file_based_input_fn_builder(input_file, seq_length, is_training, drop_remainder):
    ...
    name_to_features = {
        ...
        "label_ids": tf.FixedLenFeature([26], tf.int64), # should match the number of labels
